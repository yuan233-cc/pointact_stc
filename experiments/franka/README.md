...
Gradient checkpointing is disabled by default on this high-memory setup; set
`GRADIENT_CHECKPOINTING=True` if a larger batch causes an out-of-memory error.
